            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('password.change') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="password" class="d-block">Password Baru <small class="text-muted">*Min. 8 digit</small></label>
                        ...
                        <div class="form-group">
                            <label for="password_confirmation">Konfirmasi Password <small class="text-muted">*Min. 8 digit</small></label>
