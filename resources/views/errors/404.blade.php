                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="text-center">
                                <img class="img-fluid p-4" src="{{ asset('/frontend/src/assets/img/freepik/404-error-with-a-cute-animal-pana.svg') }}"
                                    alt="404 Not Found" style="width:400px;height:500px;" />
                                <p class="lead mt-n5">Anda tidak memiliki akses ke halaman ini.
                                </p>
