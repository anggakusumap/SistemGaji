                                        ...
                                        @if ($item->User != null)
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select class="form-control form-control-sm" style="display: none" name="id_user">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <button class="btn btn-sm btn-secondary" type="button"
                                                        onclick="tambahpotongan(event,)">Hitung</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    function simpandata(event, id_detail_gaji, id_gaji_pegawai) {
        ...
        var tunj_setelah_pot_absen = tunj_setelah_pot_absen_element.replace(',', '').replace(',', '').replace(',', '')
            .trim()
        ...
        var potongan_cakti_buddhi_bhakti = potongan_cakti_buddhi_bhakti_el.replace(',', '').replace(',', '').replace(
            ',', '').trim()
        ...
        var potongan_kop_bali_sedana = potongan_kop_bali_sedana_el.replace(',', '').replace(',', '').replace(',', '')
            .trim()
        ...
        if ( gaji_pokok == '' | tunjangan_istrisuami == '' | tunjangan_anak == '' |
            ...
            bpjs == '' | sewa_rumah == '' | pph_pasal_21 == '' | jumlah_potongan == '' | jumlah_bersih_gaji == '' |
            tunjangan_kinerja == '' | jumlah_potongan_lainnya == '' | penerimaan_total == '' | potongan_absen == '' |
            potongan_absen_persen == '' | tunj_setelah_pot_absen == '' | potongan_dana_punia == '' | potongan_mushola ==
            '' | potongan_nasrani == '' | potongan_ar == '' | potongan_bpd == '' | potongan_bjb == '' |
            potongan_cakti_buddhi_bhakti == '' | potongan_anak_asuh == '' | potongan_futsal == '' | potongan_umum ==
    ...
    function hitunggaji(event) {
        ...
        if (gaji_pokok == '' | tunjangan_istrisuami == '' | tunjangan_anak == '' | tunjangan_jabatan_struktural == '' |
            ...
            // PERHITUNGAN KOTOR
            var perhitungan_kotor = parseInt(gaji_pokok) + parseInt(tunjangan_istrisuami) + parseInt(tunjangan_anak) +
            ...
            var perhitungan_potongan = parseInt(iuran_wajib) + parseInt(bpjs) + parseInt(sewa_rumah) + parseInt(
                pph_pasal_21)
                    ...
                    if (tunjangan_kinerja == '' | tunjangan_kinerja == 0) {
                        ...
                        if (potongan_absen == '' | tunj_setelah_pot_absen == '' | potongan_dana_punia == '' |
                            ...
                            var perhitungan_jumlah_potongan = parseInt(potongan_absen) + parseInt(
                                ...
                                parseInt(
                                    potongan_bjb) +
                                parseInt(potongan_cakti_buddhi_bhakti) + parseInt(potongan_anak_asuh) +
